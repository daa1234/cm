...
window.Pagelet = function() {
    ...
    i = function(t) {
        n.$el = $(n.el),
        n.$el.length && ("function" == typeof n.template && n.$el.html(n.template()), c(), n.init && $.isFunction(n.init) && n.init(t), r())
    },
    c = function() {
        n.$dom = {};
        for (var t, e, o = n.$el.html() || "", i = o.match(/data-node="([^"]*)"/gim) || [], c = i.length - 1; c >= 0; c--) t = i[c],
        e = t.split("=")[1].replace(/"/g, ""),
        n.$dom[e] = n.$el.find("[" + t + "]")
    },
    r = function() {
        var t, e, o, i, c = n.events,
        r = n.channels,
        l = /^(\S+)\s*(.*)$/,
        p = /^\$/;
        c && c instanceof Object && $.each(c,
        function(o, c) {
            return $.isFunction(c) || (c = n[c]),
            c ? (i = o.match(l), t = i[1], e = i[2], p.test(e) && (e = '[data-node="' + e.replace("$", "") + '"]'), void u(t, e, c)) : !0
        }),
        r && r instanceof Object && $.each(r,
        function(e, c) {
            return $.isFunction(c) || (c = n[c]),
            c ? (i = e.match(l), o = i[1], t = i[2], void a(o, t, c)) : !0
        })
    },
    u = function(t, o, i) {
        var c = n.el || "body";
        o ? $(c).on(t, o, $.proxy(i, n)) : $(c).on(t, $.proxy(i, n)),
        e.push([t, o, i])
    },
    a = function(t, e, i) {
        listener.on(t, e, $.proxy(i, n)),
        o.push([t, e, i])
    };
