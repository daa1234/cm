$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', $("#project_Name").val()+'/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', $("#project_Name").val()+'/css/bootstrap-' + themeName + '.min.css');
        }
