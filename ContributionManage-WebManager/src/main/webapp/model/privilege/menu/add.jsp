...
<%@ include  file="/jsp/header.jsp" %>
   <div>
    ...
    <div class="box-content">
            <form role="form" class="form-horizontal " action="${projectName }/menu/saveAction.action" method="post">  
                <div class="form-group">  
                 ...
                 <div class="form-group">  
                    ...
                    <div class="col-md-9">  
                        <input class="form-control" name="uri" type="text" id="uri" placeholder="uri" value="" />  
                    </div>  
                </div>  
                <div class="form-group">  
                    <label class="col-md-2 control-label" for="sequence">排序号</label>  
                    <div class="col-md-9">  
                        <input class="form-control" name="sequence" type="text" id="sequence" placeholder="sequence" value="" />  
                    </div>  
                </div>
				<div class="form-group">
					...
					<div class="col-md-2">  
						<select  name="pid" class="form-control" >
						  <option value="">无</option>
							<c:forEach items="${list.aaData }" var="n" >
                ...
                <div class="form-group" id="remark">  
                    <label for="intro" class="control-label col-md-2">备注</label>  
                    <div class="col-md-9">  
                        <textarea id="remark" class="form-control" rows="5" name="remark" placeholder="remark"></textarea>  
                    </div>  
                </div>  
