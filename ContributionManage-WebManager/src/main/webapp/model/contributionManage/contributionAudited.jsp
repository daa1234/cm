...
<%@ include  file="/jsp/header.jsp" %>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-leaf"></i>稿件已审核</h2>
...
//  		"sDom":   '<"top"fli>rt<"bottom"p><"clear">',
		...
		"bAutoWidth": true,
    	"sAjaxSource": '${projectName }/contributionManage/queryAudited.action',
    		"aoColumns":
 	           [  
...
/**
	...
	function initComplete(data) {
		...
		var dataPlugin = "";
		dataPlugin = ''
				+ '<label>审核状态:<select id="auditStatus"><option value=""> </option><option value="-1">未通过</option><option value="1">已通过</option><option value="2">已结算</option></select></label>'
				+ '';
