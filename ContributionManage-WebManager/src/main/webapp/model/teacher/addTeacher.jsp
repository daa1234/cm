...
<%@ include  file="/jsp/header.jsp" %>
    ...
    <div class="box-content">
            <form role="form" class="form-horizontal " action="${projectName }/teacher/editAction.action" method="post">  
                <div class="form-group">  
                    <label class="col-md-2 control-label" for="realName">姓名</label>  
                    <div class="col-md-6">  
                        <input class="form-control" name="realName" type="text" id="realName" placeholder="真实姓名" " />  
                    </div>  
                </div>  
                <div class="form-group">  
                    <label class="col-md-2 control-label" for="nickName">呢称</label>  
                    <div class="col-md-6">  
                        <input class="form-control" name="nickName" type="text" id="nickName" placeholder="呢称" />  
                    </div>  
                </div>  
<!--                 <div class="form-group"> -->
...
<!-- 				</div> -->
				...
				<div class="form-group">
					<label  class="col-md-2 control-label" for="type">所在时区</label>
					<div class="col-md-3">  
						<select id="timeZoneCode" name="timeZoneCode" class="form-control" >
							<option value="">选择时区</option>
						  <c:forEach items="${timeZoneLst}" var="t">
				 ...
				 <div class="form-group">  
                    ...
                    <div class="col-md-6">  
                        <input class="form-control" name="mobile" type="text" id="mobile" placeholder="手机号" />  
                    </div>  
                </div>  
                ...
                <div class="form-group">  
                    ...
                    <div class="col-md-6">  
                        <input class="form-control" name="email" type="text" id="email" placeholder="邮箱地址"  />  
                    </div>  
                </div>  
                ...
                <hr/>
                  ...
                  <div class="form-group">  
                    ...
                    <div class="col-md-6  ">  
                        <input class="form-control" name="loginName" type="text" id="loginName" placeholder="登录名" />  
				 ...
				 <div class="form-group" >  
                    ...
                    <div class="col-md-6">  
                        <input class="form-control" name="password" type="password" id="password" placeholder="登录密码" />  
                    </div>  
                </div>  
                 ...
                 <div class="form-group" >  
                    ...
                    <div class="col-md-6">  
                        <input class="form-control" name="confirm_password" type="password" id="confirm_password" placeholder="确认密码" />  
                    </div>  
                </div>  
