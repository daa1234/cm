		...
		<div class="box-inner">
			...
			<div class="box-content">
				<div class="alert alert-info">
					<a href="${projectName }/systemUser/addPage.action" class="btn btn-success" href="#">
...
<%=request.getParameter("iDisplayStart") == null ? 0 : request.getParameter("iDisplayStart")%>
	,
							...
							"bAutoWidth" : true,
							"sAjaxSource" : '${projectName }/systemUser/searchUserAction.action',
							"aoColumns" : [
									{
										"mData" : "realName",
										'sClass' : 'center'
									...
									},
									{
										...
										"mRender" : function(data, type, full) {
											return "<a style='margin-right: 4px;' class='btn btn-success'  onclick='preSubmit(\""
													+ "${projectName }/systemUser/showPage.action?id="
													+ data
													+ "\")'  href='javascript:;' ><i class='glyphicon glyphicon-zoom-in icon-white'></i>"
													+ "\n详情</a>"
													+ "<a class='btn btn-info' href='${projectName }/systemUser/editPage.action?id="
													+ data
